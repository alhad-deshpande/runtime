  ...
  runtime-build()
  {
      ...
      BUILD_EXIT_CODE=0
      OPENSSL_ENABLE_SHA1_SIGNATURES=1 ./build.sh /p:WarningsNotAsErrors=NU1905 /p:WarningsNotAsErrors=NU1900 ${common_args[@]+"${common_args[@]}"} ${build_args[@]+"${build_args[@]}"} || BUILD_EXIT_CODE=$?
