...
#define DT_CONTEXT_PPC64LE 0x200000

#define DT_CONTEXT_CONTROL        (DT_CONTEXT_PPC64LE | 0x1L)
#define DT_CONTEXT_INTEGER        (DT_CONTEXT_PPC64LE | 0x2L)
#define DT_CONTEXT_FLOATING_POINT (DT_CONTEXT_PPC64LE | 0x4L)
#define DT_CONTEXT_DEBUG_REGISTERS (DT_CONTEXT_PPC64LE | 0x8L)

#define DT_CONTEXT_FULL (DT_CONTEXT_CONTROL | DT_CONTEXT_INTEGER | DT_CONTEXT_FLOATING_POINT)
#define DT_CONTEXT_ALL  (DT_CONTEXT_CONTROL | DT_CONTEXT_INTEGER | DT_CONTEXT_FLOATING_POINT | DT_CONTEXT_DEBUG_REGISTERS)

#define DT_PPC64LE_MAX_BREAKPOINTS 8
#define DT_PPC64LE_MAX_WATCHPOINTS 1
