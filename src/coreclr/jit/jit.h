...
#elif defined(TARGET_POWERPC64)
#define IMAGE_FILE_MACHINE_TARGET IMAGE_FILE_MACHINE_POWERPC
#else
#error Unsupported or unset target architecture
#endif
...
#if defined(TARGET_POWERPC64)
#define UNIX_POWERPC64_ONLY_ARG(x) , x
#define UNIX_POWERPC64_ONLY(x) x
#else // !TARGET_POWERPC64
#define UNIX_POWERPC64_ONLY_ARG(x)
#define UNIX_POWERPC64_ONLY(x)
