...
#elif defined(TARGET_ARM) || defined(TARGET_ARM64) || defined(TARGET_LOONGARCH64) || defined(TARGET_RISCV64) || defined(TARTGET_POWERPC64)
        !m_HasTailCalls &&
#endif // TARGET_AMD64
...
#elif defined(TARGET_POWERPC64)
        assert(m_StackBaseRegister == 1 || 31 == m_StackBaseRegister);
#endif
