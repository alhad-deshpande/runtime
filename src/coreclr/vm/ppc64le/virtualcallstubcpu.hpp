...
//
//This file has yet not been ported to Power.
//Ulrich has copied it from arm64 as it is for now.
//Have done same for power
...
void VTableCallHolder::Initialize(unsigned slot)
{
 _ASSERTE(!"S390X:NYI");
    ...
    *(UINT32*)p = 0xF9400009; p += 4;
    ...
    unsigned int dataOffset = codeSize - indirectionsDataSize - 4;
