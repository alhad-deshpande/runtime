                                    ...
                                    HostCallPreference hostCallPreference /* = (HostCallPreference)(-1) */)
{
    ...
    ctx.Nip = baseState->m_CaptureRip;
    ctx.R1 = baseState->m_CaptureRsp ; // +8 for return addr pushed before calling LazyMachStateCaptureState
...
#undef CALLEE_SAVED_REGISTER
    ...
    unwoundState->m_Rip = ctx.Nip;
    unwoundState->m_Rsp = ctx.R1;
