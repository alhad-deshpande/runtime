...
#define               OFFSETOF__MachState__m_Ptrs           0xA0        // 0x10 + 18*8(0x90)
#define               OFFSETOF__MachState___pRetAddr        0x130       // 0xA0 + 18*8(0x90)
#define               OFFSETOF__LazyMachState__m_CaptureRip 0x1C8       // 0x130 + 18*8(0x90) + 8
#define               OFFSETOF__LazyMachState__m_CaptureRsp 0x1D0       // 0x1C8 + 8
