...
#error this file should only be used on an ppc64le platform
...
ASMCONSTANTS_C_ASSERT(OFFSETOF__LazyMachState__m_CaptureNip
                    == offsetof(LazyMachState, m_CaptureNip));
